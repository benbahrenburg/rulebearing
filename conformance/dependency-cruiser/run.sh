...
#            ../excluded.json
#
# Layers 3 to 5 (report fixtures, schema validation, oracle zero-diff) arrive with the reporters in
# wave 1 (docs/plans/pending/0001-wave-1-typescript-parity.md).
