...
| 1G | Zero-diff: dependency-cruiser, langfuse, FluidFramework | In progress | 573, 3,832 and 656 modules; 26, 369 and 1 violations; 0 differences each, locally and in the [nightly's layer 5 job](https://github.com/benbahrenburg/rulebearing/actions/runs/35894226485) on `main`. nightly rows: the table's Rulebearing and zero-diff columns take them from layer 5 once this change runs nightly |
