...
| 1G | `docs/perf.md`: private monorepo and synthetic figures | In progress | Synthetic, on `ubuntu-latest`: mean: 0.966 s, p95: 1.005 s over 10 runs at `f2e4804` ([bench run](https://github.com/benbahrenburg/rulebearing/actions/runs/35894230077), [docs/perf.md](../../perf.md)). The private monorepo's figure is the maintainer's to take |
